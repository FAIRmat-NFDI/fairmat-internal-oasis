![docker image](https://github.com/FAIRmat-NFDI/fairmat-internal-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/FAIRmat-NFDI/fairmat-internal-oasis.git
    cd fairmat-internal-oasis
    ```

    or

    ```sh
    curl-L -o fairmat-internal-oasis.zip "https://github.com/FAIRmat-NFDI/fairmat-internal-oasis/archive/main.zip"
    unzip fairmat-internal-oasis.zip
    cd fairmat-internal-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/fairmat-nfdi/fairmat-internal-oasis:main` for the services
...
```sh
docker pull ghcr.io/fairmat-nfdi/fairmat-internal-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/FAIRmat-NFDI/fairmat-internal-oasis/manifests/main": unauthorized`
